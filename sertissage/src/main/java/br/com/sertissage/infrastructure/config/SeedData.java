...
import br.com.sertissage.repository.CategoriaMaterialRepository;
import br.com.sertissage.repository.MaterialRepository;
...
public class SeedData {
    ...
    CommandLineRunner seed(
        ...
        return args -> {
            ...
            // Idempotente — aborta se já foi executado
